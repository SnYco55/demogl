  ...
  <section class="space-y-6">
    ...
    <header class="flex items-center justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Gérez les départements de l'université.</p>
      </div>
    ...
    <section v-if="showForm" class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div class="space-y-4">
        ...
        <!-- Faculty ID -->
        <div>
          <label for="faculty-id" class="mb-2 block text-sm font-medium text-gray-700">
            ID de la faculté
          </label>
        ...
        <div class="flex justify-end gap-3">
          ...
          >
            {{ saving ? 'Enregistrement...' : editingDepartment ? 'Enregistrer' : 'Ajouter' }}
          </button>
        </div>
      </div>
    </section>
    ...
    <section v-else class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
      <div v-if="departments.length === 0" class="p-8 text-center text-sm text-gray-500">
        Aucun département.
      </div>
      ...
      <div v-else class="divide-y divide-gray-100">
        ...
        >
          <div class="min-w-0">
            ...
            <p class="mt-1 text-sm text-gray-400">Faculté : {{ department.facultyId }}</p>
          </div>
